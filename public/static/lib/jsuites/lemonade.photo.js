var photo = (function(photoContainer) {
    // Square propertion
                ...
                <div role='tabs'>
                    ...
                    <div role='content' style='background-color: #ccc;'>
                        <div style='text-align: center;'>
                            <label style="text-align: center; display: inline-block;"> Zoom <input type='range' step='.05' min='0.1' max='5.45' value='1' oninput='self.updateZoom(this)' style="display: block;" class='jrange controls' disabled='disabled'></label>
                            <label style="text-align: center; display: inline-block; margin-left: 20px;"> Rotate <input type='range' step='.05' min='-1' max='1' value='0' oninput='self.updateRotate(this)' style="display: block;" class='jrange controls' disabled='disabled'></label>
                        </div>
                        <div style='text-align: center;'>
                            <label style="text-align: center; display: inline-block;"> Brigthness <input type='range' min='-1' max='1' step='.05' value='0' @bind='self.brightness' oninput='self.setBrightness(this)' style="display: block;" class='jrange controls' disabled='disabled'></label>
                            <label style="text-align: center; display: inline-block; margin-left: 20px;"> Contrast <input type='range' min='-1' max='1' step='.05' value='0' @bind='self.contrast' oninput='self.setContrast(this)' style="display: block;" class='jrange controls' disabled='disabled'></label>
                        </div>
                    </div>
                </div>
