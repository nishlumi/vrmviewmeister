    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-5  q-pl-sm q-pr-sm">
                <q-btn flat round @click="onclick_rotation_getmouse">
                    <q-tooltip>{{ $t('get_mousepos')}}</q-tooltip>
                    <q-icon name="mouse" size="md"></q-icon>
                </q-btn>
                <!--<q-btn flat round @click="onclick_rotation_zero">
                    <q-tooltip>{{ $t('reset_counter')}}</q-tooltip>
                    <q-icon name="restart_alt" size="md"></q-icon>
                </q-btn>-->
            </div>
            <!--
            <div class="col-2">
            ...
            <div class="col-5  q-pl-sm q-pr-sm">                
                <q-btn flat round @click="onclick_translation_getmouse">
                    <q-tooltip>{{ $t('get_mousepos')}}</q-tooltip>
                    <q-icon name="mouse" size="md"></q-icon>
                </q-btn>
                <q-btn flat round @click="onclick_translation_zero">
                    <q-tooltip>{{ $t('reset_counter')}}</q-tooltip>
                    <q-icon name="restart_alt" size="md"></q-icon>
                </q-btn>
            </div>
