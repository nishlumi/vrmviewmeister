...
# web url
url = "https://docs.google.com/spreadsheets/d/e/...&single=true&output=tsv"


# local file path
path = '\\Translation-vrmviewer.tsv'


# output file directory
outdir = [
    "\\VRMViewMeister\\src\\locales",
    "\\VRMViewMeister\\public\\static\\locales"
]
